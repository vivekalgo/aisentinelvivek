...
function App() {
    ...
    {/* RESULTS AREA */ }
    {
        ...
        < section className = "bg-gradient-to-r from-blue-900 to-slate-900 py-16 px-6" >
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl font-bold text-white mb-4">
                    Get Legal Protection on the Go
                </h2>
                <p className="text-blue-200 mb-8 text-lg">
                    Download our Android app to scan contracts and validate clauses anywhere, anytime.
                </p>
                <a
                    href="/app-release.apk"
                    download="AI-Legal-Sentinel.apk"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 hover:bg-green-600 text-white rounded-full text-lg font-bold transition-all transform hover:scale-105 shadow-xl hover:shadow-green-500/20"
                >
